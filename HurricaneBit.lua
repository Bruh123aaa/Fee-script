...
function Ui:Window(text) 
    ...
    Logo.Image = "http://www.roblox.com/asset/?id=7232482846"
...
AFS:Seperator('Teleport')
AFS:Button("Tp To Shop",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-27.823396682739258, 8.973969459533691, -133.41957092285156)
end
)
AFS:Button("Zone 1",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-179.71713256835938, 13.973969459533691, -136.96144104003906)
end
)
AFS:Button("Zone 2",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-313.68304443359375, 13.973969459533691, -140.79110717773438)
end
)
AFS:Button("Zone 3",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-494.84130859375, 13.973969459533691, -140.79110717773438)
end
)
AFS:Button("Zone 4",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-656.4766235351562, 13.973969459533691, -140.79110717773438)
end
)
AFS:Button("Zone 5",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1953.440673828125, 11.6478910446167, 5666.458984375)
end
)
AFS:Button("Zone 6",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2206.408935546875, 13.973969459533691, 5666.458984375)
end
)
AFS:Button("Zone 7",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2413.468505859375, 13.98397159576416, 5666.458984375)
end
)
AFS:Button("Zone 8",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2623.168701171875, 14.003969192504883, 5666.458984375)
end
)
AFS:Button("Zone 9",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2839.706787109375, 13.973969459533691, 5666.458984375)
end
)
AFS:Button("Zone 10",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-3051.029296875, 13.973969459533691, 5666.458984375)
end
)
AFS:Button("Zone 11",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(36.02587890625, 6.400747299194336, -6496.25341796875)
end
)
AFS:Button("Zone 12",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-364.3273620605469, 6.400747299194336, -6591.24658203125)
end
)
AFS:Button("Zone 13",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-704.9119873046875, 6.400747299194336, -6559.95947265625)
end
)
AFS:Button("Zone 14",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-975.2437744140625, 6.400747299194336, -6501.333984375)
end
)
AFS:Button("Zone 15",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1405.111328125, 6.400747299194336, -6611.36376953125)
end
)

AFR:Seperator('Auto Function')
local Toggle1 = AFR:Toggle('Auto Collect Qi',false,function(ACO)
    _G.AutoCollectQi = ACO
end
)

spawn(function()
  while  wait(0.1) do
      if _G.AutoCollectQi then

         local Qi = game.Players.LocalPlayer.Character.HumanoidRootPart
...
FR:Seperator('Auto Function')
    local Toggle1 = FR:Toggle('Auto Collect Rocket',false,function(ACR)
...
local dropdown = Misc:Dropdown("Select Player",players,'',function(abc)
    Select = abc
end)

Misc:Button("Refresh Players",function()
    table.clear(players)
for i,v in pairs(game:GetService("Players"):GetChildren()) do
   table.insert(players,v.Name)
end
...
local Slider = Misc:Slider("WalkSpeed",true,16,100,25,function(v)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = v
end)

local Slider = Misc:Slider("JumpPower",true,20,100,32,function(k)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = k
end)

Misc:Seperator('Client')
